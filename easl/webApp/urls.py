...
urlpatterns = [
    ...
    url(r'parent_registration_page', views.parent_registration, name ='parent_registration'),
    url(r'teacher_registration_page', views.teacher_registration, name='teacher_registration'),
